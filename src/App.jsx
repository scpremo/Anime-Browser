...
import GenresDropDown from './components/GenresFilter';
...
const AnimeSearchComponent = () => {
    ...
    const onPause = (event) => {
        // Handle the pause event if needed
        //   event.target.playVideo()
        setVideoPlaying(false)
        //   console.log("try to stop pausing")
    ...
    // }, [sfw, unapproved, minScore, status, genres, genresExclude, openingFound]);
    ...
    return (
        <div>
            ...
            {!gameSetup && !scoreScreen &&(
                <div>
                    <div>Score: {score} Questions Left:{gameLength}</div>
                            ...
                            {guessing && timerUp && (
                                <div>
                                    ...
                                    <button onClick={newRound}>
                                        your applicationc clearly failed and this is 100% not actually an anime opening
                                    </button>
                                </div>
                            )}
                            {!guessing && (
                                <div>
                                    ...
                                    {randomAnime.title_english && (
                                        <div>
                                            Correct Answer = {randomAnime.title_english}
                                        </div>)}
                                    <div>
